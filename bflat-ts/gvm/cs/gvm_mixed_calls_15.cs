...
class Program
{
    static int Main()
    {
        ...
        if (b.M<int>(11) != 11) return 1;
        if (b.M<string>("s11") != "s11") return 1;
        if (b.M<int>(12) != 12) return 1;
        if (b.M<string>("s12") != "s12") return 1;
        if (b.M<int>(13) != 13) return 1;
        if (b.M<string>("s13") != "s13") return 1;
        if (b.M<int>(14) != 14) return 1;
        if (b.M<string>("s14") != "s14") return 1;
        Console.WriteLine("gvm: gvm_mixed_calls_15 ok");
        return 0;
    }
}
