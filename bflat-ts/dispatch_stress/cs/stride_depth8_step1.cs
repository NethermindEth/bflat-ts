...
class S6 : S5 { public override int F() => base.F() + 1; }
class S7 : S6 { public override int F() => base.F() + 1; }
class S8 : S7 { public override int F() => base.F() + 1; }
...
class Program
{
    static int Main()
    {
        S0 s = new S8();
        if (s.F() != 8) return 1;
        Console.WriteLine("dispatch_stress: stride_depth8_step1 ok");
        return 0;
    }
}
