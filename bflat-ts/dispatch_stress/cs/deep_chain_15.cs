...
class V11 : V10 { public override int F() => 11; }
class V12 : V11 { public override int F() => 12; }
class V13 : V12 { public override int F() => 13; }
class V14 : V13 { public override int F() => 14; }
class V15 : V14 { public override int F() => 15; }

class Program
{
    static int Main()
    {
        V0 v = new V15(); if (v.F() != 15) return 1;
        Console.WriteLine("dispatch_stress: deep_chain_15 ok");
        return 0;
    }
}
