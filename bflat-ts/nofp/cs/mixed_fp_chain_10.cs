...
class Program
{
    static int Main()
    {
        ...
        float fz8 = Holder.Fa + Holder.Fb; GC.KeepAlive(fz8);
        double dz8 = Holder.Da * Holder.Db; GC.KeepAlive(dz8);
        float fz9 = Holder.Fa + Holder.Fb; GC.KeepAlive(fz9);
        double dz9 = Holder.Da * Holder.Db; GC.KeepAlive(dz9);
        Console.WriteLine("nofp: mixed_fp_chain_10 ok");
        return 0;
    }
}
