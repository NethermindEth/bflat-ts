...
class Program
{
    static int Main()
    {
        ...
        float z9 = Holder.A * Holder.B; GC.KeepAlive(z9);
        float z10 = Holder.A + Holder.B; GC.KeepAlive(z10);
        float z11 = Holder.A * Holder.B; GC.KeepAlive(z11);
        float z12 = Holder.A + Holder.B; GC.KeepAlive(z12);
        float z13 = Holder.A * Holder.B; GC.KeepAlive(z13);
        float z14 = Holder.A + Holder.B; GC.KeepAlive(z14);
        Console.WriteLine("nofp: float_chain_indep_15 ok");
        return 0;
    }
}
